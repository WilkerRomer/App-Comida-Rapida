...
public class TinyDB {
    ...
    public ArrayList<foodDirectory> getListObject(String key){
        Gson gson = new Gson();

        ArrayList<String> objStrings = getListString(key);
        ArrayList<foodDirectory> playerList =  new ArrayList<foodDirectory>();

        for(String jObjString : objStrings){
            foodDirectory player  = gson.fromJson(jObjString,  foodDirectory.class);
    ...
    public void putListObject(String key, ArrayList<foodDirectory> playerList){
        checkForNullKey(key);
        Gson gson = new Gson();
        ArrayList<String> objStrings = new ArrayList<String>();
        for(foodDirectory player: playerList){
